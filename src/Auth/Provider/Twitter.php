...
//class TwitterSdk extends ProviderBase
class TwitterSdk
{
	...
	public function httpClientAuth()
	{
		...
		$auth = [
			'type'=>'oauth',
			'consumerKey'=>Configure::read("UserManager.TwitterConsumerKey"),
			'consumerSecret'=>Configure::read("UserManager.TwitterConsumerSecret"),
	...
	protected function buildRequestTokenHeader()
	{
		...
		$params = [
			...
			'oauth_consumer_key'=>Configure::read("UserManager.TwitterConsumerKey"),
			'oauth_version'=>'1.0'
		];
		...
		$secret = $this->_encode(Configure::read("UserManager.TwitterConsumerSecret"))."&";

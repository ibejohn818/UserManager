...
class UserAccountCustomFieldsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'field_type' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'field_options' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'created' => '2015-05-17 22:17:22',
            'modified' => '2015-05-17 22:17:22',
